...
namespace WDE.Trinity
{
    [AutoRegister]
    [SingleInstance]
    public class Trinity343Version : ICoreVersion, IDatabaseFeatures, ISmartScriptFeatures, IConditionFeatures, IGameVersionFeatures, IEventAiFeatures
    {
        public string Tag => "Trinity343";
        public string FriendlyName => "TrinityCore WotLK Classic (3.4.3)";
        ...
        public GameVersion Version { get; } = new(3, 4, 3, 54261);
